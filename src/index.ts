...
import { exportEdgeGistData, importEdgeGistData } from './admin/data'
import {
  clearOwnerSession,
  configMiddleware,
  issueOwnerSession,
...
export function createApp() {
  ...
  app.get('/:owner', (c) => {
    requireOwnerPath(c)
    return c.html(renderAdminPage(pathWithSearch(c.req.url), publicPageConfig(c)), 200, adminPageHeaders)
  })
