...
import { isSelectedGistDetailLoading, shouldHideAdminBootShell } from '../../src/admin/detail-loading'

describe('admin detail loading gate', () => {
...
describe('admin boot shell gate', () => {
  const readyState = {
